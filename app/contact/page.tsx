...
export default function ContactPage() {
  ...
  return (
    <main className="min-h-screen bg-black text-white">
      ...
      {/* Hero Section */}
      <div className="pt-32 px-6 pb-24 bg-gradient-to-b from-purple-500/20 via-black to-black">
      ...
      <div className="px-6 py-24">
        <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-12">
          ...
          >
            {/* Response Time */}
            <div className="gradient-border p-[1px] rounded-2xl">
              <div className="flex items-center gap-4 p-6 rounded-2xl bg-black">
            ...
            <div className="gradient-border p-[1px] rounded-2xl">
              <div className="bg-black rounded-2xl p-8 space-y-6">
                ...
                <div className="space-y-4">
                  <a href="tel:+918800526844" className="flex items-center gap-4 p-4 rounded-xl bg-white/5 hover:bg-white/10 transition-colors">
                    <Phone className="w-6 h-6 text-purple-400" />
                    <span>+91-8800526844</span>
                  </a>
                  
                  <a href="mailto:hello.elevateweb@gmail.com" className="flex items-center gap-4 p-4 rounded-xl bg-white/5 hover:bg-white/10 transition-colors">
                    <Mail className="w-6 h-6 text-purple-400" />
                    <span>hello.elevateweb@gmail.com</span>
                  </a>
                  ...
                  <div className="flex items-center gap-4 p-4 rounded-xl bg-white/5">
                    ...
                    <span>16, Gyankhand-1, Indirapuram, Ghaziabad</span>
                  </div>
                </div>
              </div>
            </div>
